...
@section('content')
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<br><br>
            {!! Form::open(['url'=>'/deleteusahaAdmin/' . $usaha->id , 'method' => 'delete', 'style'=>'display:inline-block']) !!}
                <button class="btn btn-primary" type="submit" onclick="deleteobject">Hapus UKM <span class="glyphicon glyphicon-trash"></span></button>
            {!! Form::close() !!}
