...
<script>
	...
	<form role ="form" method="POST" action ="{{ url('izin/IzinUsahaPusatPerbelanjaan/store') }}" enctype="multipart/form-data">
		...
		<div class ="form-group" id ="DataPribadi">
			@include('izin.user.formidentitas')
            	...
            	<select name = "KegiatanUsaha">
	               ...
	               <option value = "Pusat Perdagangan">Pusat Perdagangan</option>
	            </select>
		...
		<div id ="DataIzinUsahaTerpadu" class ="form-group">
				...
				<input type="text" id="AktaPendirianFile" name ="AktaPendirianFile" required placeholder="nomor akta pendirian">
