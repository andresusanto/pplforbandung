    ...
    <div class="top-menu">
     <ul class="nav pull-right top-menu">
      <?php if(\Session::has('id')==false){ ?>
          <li><a class="logout" href={{"http://dukcapil.pplbandung.biz.tm/oauth/authorize?client_id=OGOQfMz8DIeNf7OF&redirect_uri=".URL::to('loginsso')."&response_type=code"}}>Login</a></li>
      <?php }else{ ?>
      <li>
