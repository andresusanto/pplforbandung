                        ...
                        <div class="content clearfix">
                            <form action="" method="post">
                                ...
                                <div class="login-fields">
                                    ...
                                    <div class="field">
                                        <p>Client ID:</p>
                                        <input type="text" id="client-id" name="client-id" value="{{ $clientId }}">
                                    </div> <!-- /field -->
                                    <div class="field">
                                        <p>Client Secret:</p>
                                        <input type="text" id="client-secret" name="client-secret" value="{{ $clientSecret }}">
                                    </div> <!-- /field -->
                                    <div class="field">
                                        <p>Redirect URI:</p>
                                        <input type="text" id="redirect-uri" name="redirect-uri" value="{{ $redirectUri }}">
                                    </div> <!-- /field -->
                                </div> <!-- /login-fields -->
